...
;;
;; ballet は program-cps（u/=defn）で定義された CPS 関数マクロ。
;; 別ネームスペースから (mproc/ballet) と呼ぶと
;; (onlisp.chap21.cps/=ballet onlisp.common.util/*cont*)
;; に展開される（=defn の名前解決修正済み）。
...
;;
;; capture は yield で優先度を 100 → 1 に下げるため、
;; plunder（pri=98）が先に完了し、最終出力順は:
